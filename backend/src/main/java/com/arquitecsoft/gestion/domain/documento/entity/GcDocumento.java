...
public class GcDocumento {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "modificacion_id")
    private GcContratoModificacion modificacion;
    ...
    public GcActividad getActividad() { return actividad; }
    public void setActividad(GcActividad actividad) { this.actividad = actividad; }
    public GcContrato getContrato() { return contrato; }
    public void setContrato(GcContrato contrato) { this.contrato = contrato; }
    public GcContratoModificacion getModificacion() { return modificacion; }
    public void setModificacion(GcContratoModificacion modificacion) { this.modificacion = modificacion; }
    ...
    public Long getCargadoPor() { return cargadoPor; }
    public void setCargadoPor(Long cargadoPor) { this.cargadoPor = cargadoPor; }
